...
<tr>
   ...
   <td><select name="phone1">
         ...
         <option value="010" ${phone1 eq '010' ? "selected='selected'" : 'null' }>02</option>
         <option value="011" ${phone1 eq '011' ? "selected='selected'" : 'null' }>02</option>
         <option value="016" ${phone1 eq '016' ? "selected='selected'" : 'null' }>02</option>
         <option value="017" ${phone1 eq '017' ? "selected='selected'" : 'null' }>02</option>
         <option value="018" ${phone1 eq '018' ? "selected='selected'" : 'null' }>02</option>
         <option value="019" ${phone1 eq '019' ? "selected='selected'" : 'null' }>02</option>
       </select>&nbsp;-&nbsp;
       <input type="text" name="phone2" size="5" value="${phone2}" />&nbsp;-&nbsp;
       <input type="text" name="phone3" size="5" value="${phone3}" /></td></tr>
<tr>
...
<tr>
   ...
   <input type="button" value="취소" onClick="javascript:window.location='member.mdo?cmd=login'"/></td></tr>
</table>
</form>
</body>
</html>